...
(pretty-hydra-define tony-shortcut
  (:quit-key "q" :color pink)
  ("浏览"
   (("l" ibuffer-list-buffers "Buffer列表" :exit t)
...
(global-set-key (kbd "M-`") 'tony-shortcut/body)
(global-set-key (kbd "<f7>") 'tony-shortcut/body)
